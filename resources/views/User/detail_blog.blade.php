                    ...
                    <div class="navigation-area">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="thumb">
                                    <a
                                        href="{{ route('blog.show', ['blog' => Str::slug($prev->blog_name), 'type' => $prev->blog_id]) }}">
                                        <img style="height: 60px;width: 60px;" class="img-fluid"
                                            src="{{ asset('uploads/blog/'.$prev->blog_image) }}" alt="">
                                    </a>
                                </div>
                                <div class="arrow">
                                    <a
                            ...
                            <div
                                ...
                                <div class="detials">
                                    <p>Next Post</p>
                                    <a
                                        href="{{ route('blog.show', ['blog' => Str::slug($next->blog_name), 'type' => $next->blog_id]) }}">
                                ...
                                <div class="thumb">
                                    <a
                                        href="{{ route('blog.show', ['blog' => Str::slug($next->blog_name), 'type' => $next->blog_id]) }}">
                                        <img style="height: 60px;width: 60px;" class="img-fluid"
                                            src="{{ asset('uploads/blog/'.$next->blog_image) }}" alt="">
                                    </a>
                                </div>
                            </div>
                            @endif
