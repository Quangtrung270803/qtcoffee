...
<section class="confirmation_part padding_top2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-lg-6 col-lx-4">
                <div class="single_confirmation_details">
                    ...
                    <ul>
                        ...
                        <li>
                            <p>data</p><span>:
                                {{ Carbon\Carbon::parse($orderd->created_at)->toFormattedDateString() }}</span>
                        </li>
                        <li>
                            <p>total</p> <span id="total"></span>
                        </li>
                        <li>
                            <p>mayment methord</p><span>:
                                {{ $customer->customer_pay == 'COD' ? 'Cash on delivery' : 'Vnpay' }}</span>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th> <span>{{ number_format($order->order_detail_qty * $order->product_price) }}</span>
                                </th>
                            </tr>
                            @endforeach
                            <tr>
