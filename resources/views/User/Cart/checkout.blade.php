...
<!--================Checkout Area =================-->
<section class="checkout_area padding_top2">
            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="col-md-12 form-group p_star">
                            <input type="email" placeholder="Email Address" required class="form-control" id="email"
                        ...
                        <div class="order_box">
                            ...
                            <div class="payment_item active">
                                <div class="radion_btn">
                                    ...
                                    <img style="width: 21%"
                                        src="{{ asset('frontend/img/product/single-product/cart2.png') }}" alt="" />
                                    <div class="check"></div>
                                </div>
                                <p>
                                    Please send a check to Store Name, Store Street, Store Town
