...
<head>
    ...
    <title>@yield('title') QTcoffee- Admin</title>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="{{ route('dashboard.index') }}"><i class="fas fa-dragon"></i> QTcoffee Admin</a>
                        </div>
                        <div class="toggler">
                    ...
                    <div class="float-start">
                        <p>{{ now()->format('Y') }} &copy; All Rights Reserved.
                            This website is completed by <span class="text-danger"><i class="bi bi-heart"></i></span><a
                                target="_blank"
                                href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=trungdo1234554321@gmail.com.com&su=Help&body=Hi+Guy,%0AI+need+your+help">
                                Quang Trung</a></p>
                    </div>
                </div>
            </footer>
