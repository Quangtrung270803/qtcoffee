...
<head>
    ...
    <title>QTcoffee</title>
    <link rel="icon" href="{{ asset('frontend/img/banner/logofavico.png') }}">
    <!-- Bootstrap CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('home.index') }}"> <img src="{{ asset('frontend/img/qtcoffee/logo.png')  }}" width="70px" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('allpro.index') }}">Shop</a>
                                </li>
                                <!--
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="{{ route('allpro.index') }}">  Products</a>
                                    </div>
                                </li>
                                -->
                                <!--
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ Auth::check() ? route('logout.create') : route('sign.index') }}"> {{ Auth::check() ? 'logout' : 'login'  }}</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> | <i class="ti-heart" aria-hidden="true"></i> by <a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=trungdo1234554321@gmail.com.com&su=Help&body=Hi+Guy,%0AI+need+your+help" target="_blank">QTcoffee</a>
